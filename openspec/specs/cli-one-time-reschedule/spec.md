# cli-one-time-reschedule Specification

## Purpose
Define the `vespera task reschedule` CLI command behavior for updating the execution time of pending one-time tasks.
