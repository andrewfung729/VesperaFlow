# pi-executor Specification

## Purpose
Define how VesperaFlow exposes, preflights, runs, records, and documents the
Pi coding agent executor across API, Worker, CLI, Web, and shared domain
contracts.
## Requirements
